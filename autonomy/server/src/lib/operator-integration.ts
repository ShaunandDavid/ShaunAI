 ...
 */
export function isBrowserTask(message: string): boolean {
...
): Promise<{ ok: boolean; content: string; screenshot?: string }> {
 ...
 */
export async function doScreenshot(): Promise<{ ok: boolean; content: string; screenshot?: string }> {
  if (!page) {
